...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Display (or export as PNG) the results using matplotlib")
    parser.add_argument("--png-save", type=Path, help="optional PNG export destination")
    parser.add_argument("directory", type=Path, help="directory containing the data.csv generated by gen_results.py")
